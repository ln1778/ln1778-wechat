...
#pragma mark - WxChatApiDelegate
/*! @brief 接收并处理来自微信终端程序的事件消息
 *
 * 接收并处理来自微信终端程序的事件消息，期间微信界面会切换到第三方应用程序。
 * WxChatApiDelegate 会在handleOpenURL:delegate:中使用并触发。
 */
@protocol WxChatApiDelegate <NSObject>
@optional
...
/*! @brief WxChatApi的成员函数，向微信终端程序注册应用支持打开的文件类型。
 *
